...
- Du veränderst nichts in den Engineering-Plane-Projekten (BIZ,
  DEV / NW / WEBOSS). Deine Lane ist ausschließlich HQ.
...
- Tickets im Engineering-Track (BIZ, DEV / NW, WEBOSS). Berührst
  du nicht.
...
- Engineering-Tickets anfassen (BIZ, DEV / NW, WEBOSS). Berührst
